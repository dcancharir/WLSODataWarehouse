...
namespace DWPersistence.Migrations
{
    ...
    [Migration("20260410213725_fechaoperaciontabla")]
    partial class fechaoperaciontabla
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DWDomain.DWBonusStatusLog", b =>
                {
                    ...
                    b.Property<decimal>("BonusId")
                        .HasColumnType("decimal(20,0)")
                        .HasColumnName("bonusId")
                        .HasComment("Id de Bono");
                    ...
                    b.Property<DateOnly?>("SetDate")
                        ...
                        .HasComment("Fecha actualizacion de status");

                    b.Property<DateTime?>("SetDatetime")
                        .HasColumnType("datetime2")
                        .HasColumnName("setDatetime")
                        .HasComment("Fecha Hora actualizacion de status");
                    ...
                    b.ToTable("BonusStatusLog", null, t =>
                        {
                            t.HasComment("Log de cambio de Status de los Bonos");
                        });
                });

            modelBuilder.Entity("DWDomain.DWBonuse", b =>
                {
                    ...
                    b.Property<long?>("ActivatedTimestamp")
                        .HasColumnType("bigint")
                        .HasColumnName("activatedTimestamp")
                        .HasComment("activaite epoch");
                    ...
                    b.Property<long?>("AmountWin")
                        .HasColumnType("bigint")
                        .HasColumnName("amountWin")
                        .HasComment("Monto ganado o balance conseguido con el bono antes de hacer la conversion.");

                    b.Property<long?>("EndTimestamp")
                        .HasColumnType("bigint")
                        .HasColumnName("endTimestamp")
                        .HasComment("expirate epoch");

                    b.Property<long?>("InsTimestamp")
                        .HasColumnType("bigint")
                        .HasColumnName("insTimestamp")
                        .HasComment("epoch de registro");

                    b.Property<long?>("PlayerIdBonus")
                        .HasColumnType("bigint")
                        .HasColumnName("playerIdBonus")
                        .HasComment("Id del player");

                    b.Property<long?>("PlayerIdReal")
                        .HasColumnType("bigint")
                        .HasColumnName("playerIdReal")
                        .HasComment("Id del player");
                    ...
                    b.Property<int?>("TxAmount")
                        .HasColumnType("int")
                        .HasColumnName("txAmount")
                        .HasComment("Monto de la transacción con la que se accedio al bono");

                    b.Property<int?>("TxPayOutAmount")
                        .HasColumnType("int")
                        .HasColumnName("txPayOutAmount")
                        .HasComment("Monto pagado");

                    b.HasKey("BonusId");

                    b.ToTable("Bonuses", t =>
                        {
                            t.HasComment("Tabla de los bonos asignados");
                        });
                });

            modelBuilder.Entity("DWDomain.DWBonusesStatus", b =>
                {
                    ...
                    b.Property<DateOnly?>("InsDate")
                        .HasColumnType("date")
                        .HasColumnName("insDate")
                        .HasComment("Fecha insercion");

                    b.Property<DateTime?>("InsDatetime")
                        .HasColumnType("datetime2")
                        .HasColumnName("insDatetime")
                        .HasComment("Fecha Hora insercion");

                    b.Property<long?>("InsTimestamp")
                        .HasColumnType("bigint")
                        .HasColumnName("insTimestamp")
                        .HasComment("Epoch insercion");

                    b.Property<int?>("InsUserId")
                        .HasColumnType("int")
                        .HasColumnName("insUserId")
                        .HasComment("Usuario insercion");
            ...
            modelBuilder.Entity("DWDomain.DWCustomer", b =>
                {
                    ...
                    b.Property<short?>("EmailChecked")
                        .HasColumnType("smallint")
                        .HasColumnName("emailChecked");
                    ...
                    b.Property<long?>("LastLoginTimestamp")
                        .HasColumnType("bigint")
                        .HasColumnName("lastLoginTimestamp");
                    ...
                    b.Property<short?>("PhoneChecked")
                        .HasColumnType("smallint")
                        .HasColumnName("phoneChecked");
            ...
            modelBuilder.Entity("DWDomain.DWGame", b =>
                {
                    ...
                    b.Property<string>("Type")
                        ...
                        .HasColumnName("type")
                        .IsFixedLength()
                        .HasComment("Tipo de juego: SLOTS, SPORTS, CASINO, POKER, etc...");
            ...
            modelBuilder.Entity("DWDomain.DWHistorialMigracionWSLO", b =>
                {
                    b.Property<DateTime>("fechaoperacion")
                        .HasColumnType("date");

                    b.Property<int>("bonusstatuslog")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);
                    ...
                    b.Property<int>("realgameevents")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);

                    b.HasKey("fechaoperacion");

                    b.ToTable("DWHistorialMigracionWSLOs", null, t =>
                        {
                            t.HasComment("Historial de migracion de tablas con fechas conocidas");
                        });
                });
            ...
            modelBuilder.Entity("DWDomain.DWPlayer", b =>
                {
                    ...
                    b.Property<long?>("PlayerIdRef")
                        .HasColumnType("bigint")
                        .HasColumnName("playerIdRef");
            ...
            modelBuilder.Entity("DWDomain.DWPromos", b =>
                {
                    b.Property<long>("PromoId")
                        .HasColumnType("bigint")
                        .HasColumnName("promoId")
                    ...
                    b.Property<DateTime?>("EndDatetime")
                        ...
                        .HasComment("Fecha Hora del fin de la promoción");
                    ...
                    b.Property<long>("InsUserId")
                        .HasColumnType("bigint")
                        .HasColumnName("insUserId")
                        .HasComment("Id del usuario que registro la promoción");
                    ...
                    b.Property<DateTime?>("StartDateTime")
                        ...
                        .HasComment("Vigencia-inicio. Fecha y hora UTC (sumando el timzone hora local)");
                    ...
                    b.ToTable("Promos", null, t =>
                        {
                            t.HasComment("Tabla de las promociones");
                        });
                });
            ...
            modelBuilder.Entity("DWDomain.DWStoreTxsStatus", b =>
                {
                    b.Property<short>("Status")
                        .HasColumnType("smallint")
                        .HasColumnName("status")
                    ...
                    b.ToTable("StoreTxsStatus", (string)null);
                });

            modelBuilder.Entity("DWDomain.DWUser", b =>
                {
